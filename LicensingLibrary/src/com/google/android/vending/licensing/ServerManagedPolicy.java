...
public class ServerManagedPolicy implements Policy {
    ...
    public void processServerResponse(int response, ResponseData rawData) {
        ...
        if (response == Policy.LICENSED) {
            ...
            // Michael: check for null timestamp, and provide one week period of validity.
            String VT = extras.get("VT");
            Log.w(TAG, "processServerResponse VT:" + VT);
            if (VT == null || VT.length() == 0) {
            	// provide one week validity period.
            	VT = String.valueOf(System.currentTimeMillis() + MILLIS_PER_MINUTE * 60 * 24 * 7);
            }
            setValidityTimestamp(VT);
