...
import com.studioirregular.bonniesbrunch.billing.Constants.AsyncResponse;
...
public class BillingReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		if (Config.DEBUG_LOG) Log.w(TAG, "onReceive intent:" + intent);
	...
	private void checkResponseCode(Context context, long requestId, int responseCodeIndex) {
		...
		if (Config.DEBUG_LOG) Log.d(TAG, "checkResponseCode requestId:" + requestId + ",responseCodeIndex:" + responseCodeIndex);
	...
	private void inAppNotify(Context context, String notificationId) {
		...
		if (Config.DEBUG_LOG) Log.d(TAG, "inAppNotify notificationId:" + notificationId);
		context.startService(command);
	}
